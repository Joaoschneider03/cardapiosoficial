    ...
    <section className="py-24 bg-white border-t border-secondary/50">
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-2xl md:text-4xl font-bold font-headline leading-tight text-foreground text-center mb-16">
            Quem está por trás desse material?
          </h2>

          <div className="flex flex-col md:flex-row items-center md:items-start gap-12 lg:gap-20">
            {/* Imagem Quadrada e Estática à Esquerda */}
            ...
            {/* Texto de Apresentação à Direita */}
            <div className="space-y-6 text-center md:text-left flex-1 py-2">
