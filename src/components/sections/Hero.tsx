    ...
    <header className="relative overflow-hidden bg-white pt-6">
      <nav className="container mx-auto px-6 flex justify-center items-center h-14">
        <div className="flex items-center gap-2">
          ...
          <span className="text-primary/80 font-bold text-xs tracking-tight uppercase font-body">Cardápios FitKids</span>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-6 py-12 md:py-24 flex flex-col items-center">
        <div className="max-w-3xl text-center space-y-8">
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-lg mx-auto leading-relaxed font-medium font-body">
          ...
          <div className="flex flex-col items-center gap-6 pt-2">
            <Button size="lg" className="h-14 px-10 text-base font-bold rounded-full shadow-md hover:bg-primary/90 transition-all group w-full sm:w-auto font-body">
